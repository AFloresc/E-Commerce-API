...
## Description
An API for an e-commerce platform. If you have developed the other projects in this roadmap, you will have to keep in mind everything you have learned so far:
...
![Diagram](https://assets.roadmap.sh/guest/simple-ecommerce-api-thzqo.png)
...
There's an admin panel where only you can add products, set the prices, manage inventory, and more.